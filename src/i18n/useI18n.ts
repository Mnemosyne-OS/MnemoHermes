/**
 * useI18n — translation hook, one JSON per language (muse pattern).
 *
 ...
 *               user switches language in the shell, so the cartridge
...
/** The 7 languages Mnemosyne OS ships (EN/FR/ES + DE/PT/RU/ZH beta) —
 *  the shell can hand any of them via ?lang=, so the cartridge carries all. */
 ...
 *  generated timestamps aren't stuck in one locale for other users. */
